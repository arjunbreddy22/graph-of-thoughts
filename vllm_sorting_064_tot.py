...
if __name__ == "__main__":
    ...
    Output Example:
        [0, 0, 0, 0, 1, 1, 1, 1, 2...]
    """
    print("🧠 Starting Tree of Thoughts with vLLM Server (64 elements)")
    print("=" * 60)
    print(f"📊 Testing {len(list(range(20)))} samples with Tree of Thoughts method")
    print(f"💰 Budget: ${100}")
    print(f"🤖 LLM: vLLM server (Qwen2-7B-Instruct)")
    print("=" * 60)
    
    budget = 100
    samples = list(range(20))  # Test with 20 samples for baseline evaluation
    approaches = [tot]   # Focus on Tree of Thoughts method
    ...
    print("🎉 Tree of Thoughts baseline with vLLM completed!")
