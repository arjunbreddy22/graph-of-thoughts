...
if __name__ == "__main__":
    ...
    Output Example:
        [0, 0, 0, 0, 1, 1, 1, 1, 2...]
    """
    print("🧠 Testing Original GoT with HuggingFace Llama-2-7B")
    print("=" * 60)
    
    budget = 30
    samples = [item for item in range(0, 5)]  # Test 5 samples like our vLLM version
    approaches = [got]  # Only test GoT method for comparison

    spent = run(samples, approaches, budget, "llama7b-hf")
